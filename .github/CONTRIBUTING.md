...
[Vendor Name Code of Conduct](https://github.com/:vendor/:project_name/blob/master/CODE_OF_CONDUCT.md).
...
> available [Documentation](https://github.com/:vendor/:project_name).

Before you ask a question, it is best to search for
existing [Issues](https://github.com/:vendor/:project_name/issues) that might
...
- Open an [Issue](https://github.com/:vendor/:project_name/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  the [documentation](https://github.com/:vendor/:project_name). If you are
  looking for support, you might want to
  check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the
  same issue you are having, check if there is not already a bug report existing
  for your bug or error in
  the [bug tracker](https://github.com/:vendor/:project_nameissues?q=label%3Abug).
...
- Open an [Issue](https://github.com/:vendor/:project_name/issues/new). (Since
...
This section guides you through submitting an enhancement suggestion for Vendor
Name, **including completely new features and minor improvements to existing
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/:vendor/:project_name) carefully
  and find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/:vendor/:project_name/issues) to see if
...
as [GitHub issues](https://github.com/:vendor/:project_name/issues).
...
- **Explain why this enhancement would be useful** to most Vendor Name users.
